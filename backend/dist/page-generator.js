...
exports.generatePageForIntent = generatePageForIntent;
const anthropic_client_1 = require("./anthropic-client");
async function generatePageForIntent(intentTitle, intentDescription, relevantData, siteName, themeColors, intentId) {
...
- Add this button to EVERY card/item in the page - it's essential for users to see full details`;
    ...
    function extractImagesWithContext(obj, path = '', itemName) {
